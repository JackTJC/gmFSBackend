...
func (x *SearchFileRequest) GetKeyword() string {
	if x != nil {
		return x.Keyword
	}
	return ""
...
type SearchFileResponse struct {
	...
	NodeList []*Node   `protobuf:"bytes,1,rep,name=node_list,json=nodeList,proto3" json:"node_list,omitempty"` // 搜索结果
...
func (x *SearchFileResponse) GetNodeList() []*Node {
	if x != nil {
		return x.NodeList
	}
	return nil
...
func (x *SearchFileResponse) GetBaseResp() *BaseResp {
	if x != nil {
		return x.BaseResp
	}
	return nil
...
var file_search_file_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x0f, 0x67, 0x72, 0x61, 0x64, 0x75, 0x61, 0x74, 0x65, 0x5f, 0x64, 0x65,
	0x73, 0x69, 0x67, 0x6e, 0x1a, 0x0c, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x22, 0x2d, 0x0a, 0x11, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x46, 0x69, 0x6c, 0x65,
	...
	0x64, 0x22, 0x81, 0x01, 0x0a, 0x12, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x46, 0x69, 0x6c, 0x65,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x32, 0x0a, 0x09, 0x6e, 0x6f, 0x64, 0x65,
	0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x67, 0x72,
	0x61, 0x64, 0x75, 0x61, 0x74, 0x65, 0x5f, 0x64, 0x65, 0x73, 0x69, 0x67, 0x6e, 0x2e, 0x4e, 0x6f,
	0x64, 0x65, 0x52, 0x08, 0x6e, 0x6f, 0x64, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x37, 0x0a, 0x09,
	...
	0x65, 0x52, 0x65, 0x73, 0x70, 0x42, 0x49, 0x0a, 0x13, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x72, 0x61,
	0x64, 0x75, 0x61, 0x74, 0x65, 0x2e, 0x64, 0x65, 0x73, 0x69, 0x67, 0x6e, 0x42, 0x0a, 0x53, 0x65,
	0x61, 0x72, 0x63, 0x68, 0x46, 0x69, 0x6c, 0x65, 0x5a, 0x26, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_search_file_proto_goTypes = []interface{}{
	(*SearchFileRequest)(nil),  // 0: graduate_design.SearchFileRequest
	(*SearchFileResponse)(nil), // 1: graduate_design.SearchFileResponse
	(*Node)(nil),               // 2: graduate_design.Node
	(*BaseResp)(nil),           // 3: graduate_design.BaseResp
}
var file_search_file_proto_depIdxs = []int32{
	2, // 0: graduate_design.SearchFileResponse.node_list:type_name -> graduate_design.Node
	3, // 1: graduate_design.SearchFileResponse.base_resp:type_name -> graduate_design.BaseResp
